public class LogicalOperators {
    public static void main(String[] args) {
        ...
        if (hasDrivingLicense && hasInsurance)
        {
            ...
            System.out.println("They can't drive");
        }
        ...
        if (age >= 21 && income >= 40000){
            System.out.println("You can have money");
        }else 
    {
        System.out.println("You can't have money"); 
    }
        ...
        {
            System.out.println("They can come in");
        }else{
            System.out.println("They can't come in");
        }
        ...
        if(!(option.equals("cash") || option.equals("credit"))){
            ...
            System.out.println("Chose another payment option"); 
        }else
        {
